...
<%
    ...
    try {
        ...
        String sql = "SELECT * FROM enrichment WHERE email = ?";
...
<body>
    ...
    <!-- Back Button -->
    <button class="back-button" onclick="window.location.href='module4_mailstatus.html'">Back</button>
</body>
</html>
...
%>
    <script type="text/javascript">
        ...
        window.location.href = "module4_mailstatus.html";
    </script>
<%
        }
    } catch (Exception e) {
