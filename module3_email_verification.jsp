...
<%
    ...
    try {
        ...
        String sql = "SELECT * FROM filteration WHERE email = ?";
...
<body>
    ...
    <!-- Back Button -->
    <button class="back-button" onclick="window.location.href='module3_mailstatus.html'">Back</button>
</body>
</html>
...
%>
    <script type="text/javascript">
        ...
        window.location.href = "module3_mailstatus.html";
    </script>
<%
        }
    } catch (Exception e) {
