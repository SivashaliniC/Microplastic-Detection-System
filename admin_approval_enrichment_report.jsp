...
<head>
    ...
    <title>Water Enrichment Data</title>
    ...
    <style>
        ...
        .back-button-container {
            position: absolute;
            bottom: 20px; /* Adjust this value to position the button higher or lower */
            right: 20px;  /* Adjust this value to position the button left or right */
        }
    </style>
</head>
<body>
...
<div class="container">
    <h1 class="heading">Water Enrichment Data</h1>
            ...
            <tbody>
                <%
                    ...
                    try {
                        ...
                        String sql = "SELECT * FROM enrichment_calculation"; // Update SQL to fetch from the new table
                        rs = stmt.executeQuery(sql);

                        while (rs.next()) {
                            out.println("<tr>");
                            out.println("<td>" + rs.getString("employee_id") + "</td>");
                            out.println("<td>" + rs.getString("water_body") + "</td>");
                            out.println("<td>" + rs.getDouble("remaining_calcium") + "</td>");
                            out.println("<td>" + rs.getDouble("remaining_magnesium") + "</td>");
                            out.println("<td>" + rs.getDouble("remaining_sodium") + "</td>");
                            out.println("<td>" + rs.getDouble("remaining_potassium") + "</td>");
                            out.println("<td>" + rs.getDouble("remaining_chloride") + "</td>");
                            out.println("<td>" + rs.getDouble("remaining_sulfate") + "</td>");
                            out.println("<td>" + rs.getDouble("remaining_nitrate") + "</td>");
                            out.println("<td>" + rs.getDouble("remaining_bicarbonate") + "</td>");
                            out.println("<td>" + rs.getDouble("remaining_iron") + "</td>");
                            out.println("<td>" + rs.getDouble("remaining_tds") + "</td>");
                            out.println("<td>" + rs.getDouble("microplastics_post_filtration") + "</td>");
